...
public class LoginUtil {
    ...
    public void requestOtp(String mobileNumber, OtpCallback callback) {
        ...
        Request request = new Request.Builder()
                .url("https://sv2.ideamarthosting.dialog.lk/sureshp72540920Apps/demo/requestOtp.php")
                .method("POST", body)
        ...
        try {
            ...
            if(response.code() == 200){
                ...
                if(statusCode.equals("S1000")){
                    String referenceNumber = object.getString("referenceNumber");
    ...
    public void verifyOtp(String refNumber, String otpCode, OtpCallback callback) {
        ...
        Request request = new Request.Builder()
                .url("https://sv2.ideamarthosting.dialog.lk/sureshp72540920Apps/demo/verifyOtp.php")
                .method("POST", body)
                .addHeader("Content-Type", "application/json")
                .build();
        try {
